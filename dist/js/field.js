...
Nova.booting(function (Vue, router) {
    Vue.component('index-array-files', __webpack_require__(3));
    Vue.component('detail-array-files', __webpack_require__(6));
    Vue.component('form-array-files', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("panel-item", { attrs: { field: _vm.field } }, [
    _c(
      ...
      _vm._l(JSON.parse(_vm.field.value), function(file) {
        return _c("p", [
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        fileSelected: function fileSelected(event) {
            ...
            axios.post('/nova-vendor/array-files/upload', fd).then(function (res) {
    ...
    [
      _c("template", { slot: "field" }, [
        _c("input", {
          ...
          staticClass: "hidden",
          attrs: { id: _vm.field.name, name: _vm.field.name, type: "text" },
